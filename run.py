...
pathlist, pathlistruntime = construct_pathlist(points, disp_diam, children=[exclude1, exclude2], poly_offset=0, num_path=10) #calculates the optimized path
...
show3Dpath(best_path, height_offset=30, plottype="dense", gif=True)          #Plot in 3D with respect to elevation #*(This is where it takes the longest)
